...
public sealed class UserRepresentationModel
{
    ...
    internal static UserRepresentationModel FromUser(User user, string password)
    {
        return new UserRepresentationModel
        {
            ...
            Credentials = new CredentialRepresentationModel[]
            {
                new() { Value = password, Type = "password" }
            }
        };
    }
}